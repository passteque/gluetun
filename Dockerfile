...
ENV VPN_SERVICE_PROVIDER=pia \
    ...
    AMNEZIAWG_CONTENT_PADDING_ADDITION=0 \
    AMNEZIAWG_REKEY_AFTER_TIME=0 \
    AMNEZIAWG_REKEY_TIMEOUT=0 \
    AMNEZIAWG_REJECT_AFTER_TIME=0 \
    AMNEZIAWG_KEEPALIVE_TIMEOUT=0 \
    AMNEZIAWG_MAX_HANDSHAKE_ATTEMPTS=0 \
    AMNEZIAWG_RANDOM_TRAILERS=off \
    AMNEZIAWG_DISABLE_COOKIES=off \
    ...
    # Metrics
    METRICS_TYPE=noop \
    METRICS_PROMETHEUS_LISTENING_ADDRESS=":9090" \
    # DNS
    DNS_SERVER=on \
