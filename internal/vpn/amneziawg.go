...
func buildAmneziaWgSettings(connection models.Connection,
	...
	return amneziawg.Settings{
		...
		PersistentKeepaliveInterval: *userSettings.PersistentKeepaliveInterval,
		RandomTrailers:              *userSettings.RandomTrailers,
		DisableCookies:              *userSettings.DisableCookies,
	}
}
