...
func (s *Source) getAmneziaWg(key string) (value string, isSet, matched bool) {
	...
	default:
		return s.getAmneziaWg3(key)
	}
	return value, isSet, true
}

func (s *Source) getAmneziaWg3(key string) (value string, isSet, matched bool) {
	switch key {
